...
# So what does this do? It creates an zoom2 initramfs (ramdisk) from
# the files provided in ./root/. It automatically replaces the mount
# points in init.zoom2.rc, based on which argument is passed to the
...
function display_help {
    ...
    echo -e "for its input. The init file, \033[1minit.zoom2.rc\033[0m will automatically be modified to contain the"
...
## update init.zoom2.rc with proper partition names
